 ...
 * @author ラファエル・コントレラス
 */
public class validandoRegistro extends javax.swing.JFrame {

    /**
     * Creates new form SolicitarReservacionCita2
     */
    private static validandoRegistro MensajeDeValidacion= new validandoRegistro();
    
    public validandoRegistro() {
        initComponents();
    }
    
    public static validandoRegistro getinstance(){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(validandoRegistro.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new validandoRegistro().setVisible(true);
            }
        });
    }
