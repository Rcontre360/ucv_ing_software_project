 ...
 * @author ラファエル・コントレラス
 */
public class RegistrarMedico2 extends javax.swing.JFrame {

    /**
     * Creates new form SolicitarReservacionCita2
     */
    public RegistrarMedico2() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RegistrarMedico2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RegistrarMedico2().setVisible(true);
            }
        });
    }
