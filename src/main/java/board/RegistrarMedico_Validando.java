 ...
 * @author ラファエル・コントレラス
 */
public class RegistrarMedico_Validando extends javax.swing.JFrame {

    /**
     * Creates new form SolicitarReservacionCita2
     */
    public RegistrarMedico_Validando() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RegistrarMedico_Validando.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RegistrarMedico_Validando().setVisible(true);
            }
        });
    }
