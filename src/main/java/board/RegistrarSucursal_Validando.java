 ...
 * @author ラファエル・コントレラス
 */
public class RegistrarSucursal_Validando extends javax.swing.JFrame {

    /**
     * Creates new form SolicitarReservacionCita2
     */
    public RegistrarSucursal_Validando() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RegistrarSucursal_Validando.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RegistrarSucursal_Validando().setVisible(true);
            }
        });
    }
