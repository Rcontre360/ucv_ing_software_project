 ...
 * @author ラファエル・コントレラス
 */
public class RegistrarMedico1 extends javax.swing.JFrame {

    /**
     * Creates new form ProveerDatos1
     */
    public RegistrarMedico1() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RegistrarMedico1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RegistrarMedico1().setVisible(true);
            }
        });
    }
