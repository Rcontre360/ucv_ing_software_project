 ...
 * @author ラファエル・コントレラス
 */
public class AsignarMedico_Validando extends javax.swing.JFrame {

    /**
     * Creates new form SolicitarReservacionCita2
     */
    public AsignarMedico_Validando() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AsignarMedico_Validando.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AsignarMedico_Validando().setVisible(true);
            }
        });
    }
