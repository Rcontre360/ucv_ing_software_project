 ...
 * @author ラファエル・コントレラス
 */
public class RegistrarSucursal4 extends javax.swing.JFrame {

    /**
     * Creates new form SolicitarReservacionCita2
     */
    public RegistrarSucursal4() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RegistrarSucursal4.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RegistrarSucursal4().setVisible(true);
            }
        });
    }
