 ...
 * @author ラファエル・コントレラス
 */
public class AsignarMedico2 extends javax.swing.JFrame {

    /**
     * Creates new form SolicitarReservacionCita2
     */
    public AsignarMedico2() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AsignarMedico2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AsignarMedico2().setVisible(true);
            }
        });
    }
