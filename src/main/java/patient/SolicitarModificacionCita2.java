 ...
 * @author ラファエル・コントレラス
 */
public class SolicitarModificacionCita2 extends javax.swing.JFrame {

    /**
     * Creates new form SolicitarReservacionCita2
     */
    public SolicitarModificacionCita2() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SolicitarModificacionCita2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SolicitarModificacionCita2().setVisible(true);
            }
        });
    }
