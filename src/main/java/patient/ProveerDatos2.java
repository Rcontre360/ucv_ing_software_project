 ...
 * @author ラファエル・コントレラス
 */
public class ProveerDatos2 extends javax.swing.JFrame {

    /**
     * Creates new form SolicitarReservacionCita2
     */
    public ProveerDatos2() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ProveerDatos2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ProveerDatos2().setVisible(true);
            }
        });
    }
